        ...
        public void Decode(HTTP2Stream context, Stream stream, List<KeyValuePair<string, string>> to)
        {
            ...
            while (headerType != -1)
            {
                ...
                else if (BufferHelper.ReadValue(firstDataByte, 0, 1) == 1)
                {
                    ...
                    {
                        // Literal Header Field with Incremental Indexing 鈥撨New Name
                    ...
                    {
                        // Literal Header Field with Incremental Indexing 鈥撨Indexed Name
                ...
                } else if (BufferHelper.ReadValue(firstDataByte, 0, 3) == 0)
                {
                    ...
                    {
                        // Literal Header Field without Indexing 鈥撨New Name
                    ...
                    {
                        // Literal Header Field without Indexing 鈥撨Indexed Name
                ...
                else if (BufferHelper.ReadValue(firstDataByte, 0, 3) == 1)
                {
                    ...
                    if (BufferHelper.ReadValue(firstDataByte, 4, 7) == 0)
                    {
                        // Literal Header Field Never Indexed 鈥撨New Name
                    ...
                    {
                        // Literal Header Field Never Indexed 鈥撨Indexed Name

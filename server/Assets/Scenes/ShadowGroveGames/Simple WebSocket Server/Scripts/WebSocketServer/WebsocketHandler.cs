...
{
    /// <summary>
    /// Inteface for class: WebSocketBehaviour.
    /// </summary>
    public interface IWebSocketHandler
    {
        /// <summary>
        /// Event handler for _events such as messages and errors.
        /// </summary>
    ...
    public class WebSocketHandler : IWebSocketHandler
    {
        ...
        public async Task<bool> StopAll()
        {
            ...
            foreach (var connection in _ListWithConnections.Values.ToList())
                succes = await connection.StopServerAsync();
        ...
        public async Task<bool> StopAll(string reason)
        {
            bool success = false;
            foreach (var connection in _ListWithConnections.Values.ToList())
                success = await connection.StopServerAsync();

...
{
    [CustomEditor(typeof(SimpleEventWebSocketServerScript))]
    public class SimpleEventWebSocketServerScriptDrawer : UnityEditor.Editor
    {
        ...
        {
            Texture2D headerImage = (Texture2D)Resources.Load("simple-websocket-server-banner", typeof(Texture2D));

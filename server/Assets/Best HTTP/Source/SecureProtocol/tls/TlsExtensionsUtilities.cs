...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    public abstract class TlsExtensionsUtilities
    {
        ...
        public static IList ReadCertificateAuthoritiesExtension(byte[] extensionData)
        {
            ...
            IList authorities = BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.CreateArrayList();
            while (buf.Position < buf.Length)
            {
        ...
        public static IList ReadKeyShareClientHello(byte[] extensionData)
        {
            ...
            IList clientShares = BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.CreateArrayList();
            while (buf.Position < buf.Length)
            {
        ...
        public static IDictionary ReadOidFiltersExtension(byte[] extensionData)
        {
            ...
            IDictionary filters = BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.CreateHashtable();
            while (buf.Position < buf.Length)
            {
        ...
        public static IList ReadStatusRequestV2Extension(byte[] extensionData)
        {
            ...
            IList statusRequestV2 = BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.CreateArrayList();
            while (buf.Position < buf.Length)
            {
        ...
        public static IList ReadTrustedCAKeysExtensionClient(byte[] extensionData)
        {
            ...
            IList trusted_authorities_list = BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.CreateArrayList();
            while (buf.Position < buf.Length)
            {

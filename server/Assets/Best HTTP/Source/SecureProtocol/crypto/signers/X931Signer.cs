...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Crypto.Signers
{
     ...
     * </pre>
     * where PS is a string of bytes all of value 0xBB of length such that |EB|=|n|, and TRAILER is the ISO/IEC 10118 part number芒鈧?熯for the digest. The byte string, EB, is converted to an integer value, the message representative, f.
     */

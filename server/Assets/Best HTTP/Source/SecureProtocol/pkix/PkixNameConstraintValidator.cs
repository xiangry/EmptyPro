...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Pkix
{
    public class PkixNameConstraintValidator
    {
        ...
        {
            return WithinDomain(dns, constraint) || BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.EqualsIgnoreCase(dns, constraint);
        }
        ...
        private bool IsUriConstrained(string constraint, string uri)
        {
            ...
            // a host
            return BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.EqualsIgnoreCase(host, constraint);
        }
